...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="<?php echo e(url('images/himg1.jpeg')); ?>" alt="Los Angeles" class="d-block" style="width:100%">
      </div>
      <div class="carousel-item">
        <img src="<?php echo e(url('images/himg2.jpeg')); ?>" alt="Chicago" class="d-block" style="width:100%">
      </div>
      <div class="carousel-item">
        <img src="<?php echo e(url('images/himg3.jpeg')); ?>" alt="New York" class="d-block" style="width:100%">
      </div>
    </div>
...
<div class="container-fluid mt-3">
  <div class="row mb-2 mx-2 align-items-center rounded-4 py-2 custom-color">
    <div class="col-2 d-flex align-items-center justify-content-center">
      <img src="<?php echo e(url('images/cleaning-cart.png')); ?>" class="img-fluid">
    </div>
    <div class="col-10">
    <a href="<?php echo e(route("room-service")); ?>">
      Room <br>
      Services
  </a>
    ...
    <div class="col-6 py-2">
      <div class="row border me-1 rounded-4 py-3 custom-color">
        <div class="col-4 d-flex align-items-center justify-content-center">
          <img src="<?php echo e(url('images/food.png')); ?>" class="img-fluid" >
        </div>
        <div class="col-8">
    ...
    <div class="col-6 py-2">
      <div class="row border ms-1 rounded-4 py-3 custom-color">
        <div class="col-3 d-flex align-items-center justify-content-center">
          <img src="<?php echo e(url('images/menu-of-the-day.png')); ?>" class="img-fluid" >
        </div>
        <div class="col-9">
  ...
  <div class="row mb-2 mx-2 align-items-center rounded-4 py-2 custom-color">
    <div class="col-2 d-flex align-items-center justify-content-center">
      <img src="<?php echo e(url('images/taxi.png')); ?>" class="img-fluid">
    </div>
    <div class="col-10">
      <a href="<?php echo e(route("hotel-facilities")); ?>">
      Hotel <br>
      Facilities
      </a>
...
<?php /**PATH C:\xampp\htdocs\rsapp\resources\views/dashboard.blade.php ENDPATH**/ ?>