...
<div class="container mt-5">
    <a href="<?php echo e(route("cab-booking")); ?>" class="btn btn-secondary my-3">Book Cab</a>
    ...
    <?php $__currentLoopData = $upcomingorders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="order-row">
                        ...
                        <td><?php echo e(date('d-m-Y h:ia', strtotime($order->pickup_date . ' ' . $order->pickup_time))); ?></td>
                        <td><?php echo e($order->trip_type); ?></td>
                        <td><?php echo e($order->drop_location); ?></td>
                        <td class="text-center"><?php echo e($order->no_of_persons); ?></td>
                        ...
                        <td>
                            <?php if($order->status != 3 && $order->status != 5): ?>
                                <form id="cancelForm<?php echo e($loop->iteration); ?>" action="<?php echo e(route('cab-cancel-order', ['id' => $order->id])); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\rsapp\resources\views/caborders.blade.php ENDPATH**/ ?>