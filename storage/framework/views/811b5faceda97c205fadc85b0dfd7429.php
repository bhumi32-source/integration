            ...
            <div id="verifyOtpForm" style="display: none;">
              <form method="POST">
                <div class="form-group mb-2">
                  ...
                  <div class="mb-2 text-center" style="font-size:16px;">A 6-digit code has been sent to your email.</div>
                ...
                <div class="form-group mt-1 text-center" style="display: none; font-size:14px;" id="resendBtn">
                Didn’t receive the OTP? <a href="#" id="resendOtpBtn" class="custom-link mt-2">Resend Code</a>
                </div>
                <div class="form-group mt-1 text-center">
                  <a href="#" id="changeEmailLink" class="custom-link" style="font-size:14px;"><i class="fa-solid fa-angle-left""></i>&nbsp;Change Email</a>
                </div>
              </form>
            </div>
            <br>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\New folder\rsapp\resources\views/login.blade.php ENDPATH**/ ?>