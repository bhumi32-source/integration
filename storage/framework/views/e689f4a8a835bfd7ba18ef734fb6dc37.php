...
<head>
    ...
    <style>
        ...
        .banner {
            background-image: url("<?php echo e(asset('images/banner.png')); ?>");
...
<body>
    ...
    <div class="container">
            ...
            <?php if($item->is_menu_item): ?>
                <div class="item-container">
                    <div style="position: relative;">
                        <img src="<?php echo e(asset('images/' . $item->image_path)); ?>" alt="<?php echo e($item->name); ?>">
                        <div class="badge">Menu of the Day</div>
                    </div>
                    <div class="item-details">
                        <b><?php echo e($item->name); ?></b>
                        <div class="text-muted"><?php echo e($item->description); ?></div>
                        <div class="price">Rs. <?php echo e($item->price); ?></div>
                    </div>
                </div>
            <?php elseif(request()->query('from_menu') === 'true'): ?>
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a href="<?php echo e(route('food.index', ['from_menu' => true])); ?>" class="order-now-btn">Order Now </a>
        </div>
    </div>
</body>
</html>

<?php /**PATH C:\xampp\htdocs\rsapp\resources\views/menu.blade.php ENDPATH**/ ?>