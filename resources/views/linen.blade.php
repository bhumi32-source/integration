...
<head>
    ...
    <style>
        ...
        #hero-section {
            background-image: url('{{ asset('images/linen.png') }}');
...
<body>
    ...
    <a id="cartButton" href="{{ route('linen.cart.index') }}" class="btn btn-success p-1">
    ...
    <div class="container-fluid linen-container" id="LinenContainer">
        ...
        <div class="row mx-2 mt-3 rounded position-relative align-items-center">
            <div class="col-4 p-0 text-center">
                <img src="{{ asset('images/' .$item->image_path) }}" class="img-fluid rounded linen-image" alt="Linen-Image">
            </div>
            <div class="col-8">
                <div>
                    <b>{{ $item->name }}</b>
